      ...
      <form
        ...
        <div className="form-control">
          <label className="label">
            <span className="label-text font-bold md:text-[14px] lg:text-[16px]">নাম</span>
          </label>
          <input
            type="text"
            name="name"
        ...
        <div className="form-control">
          <label className="label">
            <span className="label-text font-bold md:text-[14px] lg:text-[16px]">মন্তব্য</span>
          </label>
          <textarea className="textarea textarea-bordered focus-within:outline-none" placeholder="Comment"></textarea>
        </div>
        <div className="form-control">
          <label className="label">
            <span className="label-text font-bold md:text-[14px] lg:text-[16px]">ওয়ার্ড:</span>
          </label>
          <input
            type="number"
            name="ward"
