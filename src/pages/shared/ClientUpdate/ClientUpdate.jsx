    ...
    return (
      <div className="">
        <div className="flex justify-between px-5 m-3 py-5 bg-[#fff] shadow-sm mb-6">
          ...
          <Link to={'/main-dashboard/add-household'} className="btn bg-accentClr btn-md text-white text-lg  font-semibold hover:bg-hoverClr"><TiPlus></TiPlus>গৃহস্থ তালিকা</Link>
        </div>
        <SearchBar></SearchBar>
        <form>
          ...
          <div className="text-center ">
            <input
              type="submit"
              className="btn max-w-xs text-white font-bold hover:bg-hoverClr w-full  bg-[#65c50a]"
            />
          </div>
        </form>
      </div>
